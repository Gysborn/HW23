...
from utils import file_iter, filter_query, map_query, limit_query, unique_query, sort_query, Validator
...
def query_compiler(qwe: list): # Обработчик/компановщик запросов
